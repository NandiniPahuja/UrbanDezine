...
function App() {
  ...
  return (
    <div>
      {/* Site Loader */}
      <div id="site-loader" className={isLoading ? "loader-overlay" : "loader-overlay hide"}>
          ...
          <section id="home" className="section">
            <div className="title-container">
              <div className="title-content">
                ...
                <p className="welcome-message quote" style={{color: "black", fontWeight: "bold"}}>
