    ...
    <div className="app-container">
      <div className="nav-container">
        <div className="contact-icons">
          <a href="https://wa.me/919886010956" target="_blank" rel="noopener noreferrer" className="contact-icon">
          ...
          <a href="tel:+919886010956" className="contact-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white">
              <path d="M20 22.621l-3.521-6.795c-.008.004-1.974.97-2.064 1.011-2.24 1.086-6.799-7.82-4.609-8.994l2.083-1.026-3.493-6.817-2.106 1.039c-7.202 3.755 4.233 25.982 11.6 22.615.121-.055 2.102-1.029 2.11-1.033z"/>
            </svg>
          </a>
          <span className="contact-number">+91 988 601 0956</span>
        </div>
        <div className="nav-buttons">
          <a href="#home" className="nav-button">Home</a>
          <a href="#about" className="nav-button">About</a>
          <a href="#products" className="nav-button">Products</a>
          <a href="#footer" className="nav-button">Contact Us</a>
        </div>
      </div>
      ...
      <main>
        <section id="home" className="section">
          <div className="title-container">
            <div className="title-content">
              <p className="tagline">Gifting made memorable.</p>
              <h1 className="title">Welcome to Urban Dezine</h1>
              <p className="subheading">Customizing Your Thoughts Since 2015</p>
              ...
              <div className="services-highlight">
                ...
                <div className="service-item">
                  <span className="service-icon">📦</span>
                  <span>Brand Merch Kits</span>
                </div>
              </div>
              
              <p className="welcome-message quote">"Don't blend in. Stand out with something made just for you."</p>
        ...
        <section id="about" className="section">
          <div className="title-content">
            ...
            <p className="welcome-message">At Urban Dezine, we believe in more than just gifting. We believe in expression. Since 2015, we've helped brands, corporates, and individuals turn ideas into tangible, beautiful products. With a growing catalogue of custom goodies — like stylish diaries, premium bottles, quirky mugs, tech gadgets, uniforms, and teamwear — our mission is simple:</p>
            <p className="welcome-message" style={{ fontStyle: "italic", fontWeight: "bold", textAlign: "center", fontSize: "1.3rem", margin: "30px 0" }}>"If you can think it, we can print it."</p>
            <p className="welcome-message">From your company's next swag box to your BFF's birthday gift — our design + delivery team ensures high quality, high style, and high satisfaction.</p>
          </div>
        </section>
        ...
        <section id="products" className="section">
          <div className="title-content">
            ...
            <div className="product-items">
              ...
              <div className="product-item">
                <span className="product-icon">📓</span>
                <p>Diaries (Classic, Power Bank variants, Wooden Finish)</p>
              </div>
              <div className="product-item">
                <span className="product-icon">🎽</span>
